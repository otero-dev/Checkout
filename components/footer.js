  ...
  return (
    <FooterBox>
      <Box>
        ...
        <Box>
          <Term>
            By filling out the field, you consent for {short_name} to use
            automated technology, including texts and prerecorded messages, to
            contact you at the number and email provided about {short_name}{" "}
            offers.
          </Term>
        </Box>
        <Box display="flex" justifyContent="center">
          <a
            href={footer_icon_link}
            title="title"
            class="dmca-badge"
            target="_blank"
            rel="noopener"
          >
            <img
              src={cert_logo}
              alt="norton.com Protection Status"
              width="100px"
            />{" "}
          </a>
        </Box>
